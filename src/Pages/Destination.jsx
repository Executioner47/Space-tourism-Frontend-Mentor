  ...
  return (
    <main className="font-cfont1 bg-black text-white ">
      ...
      <div className="relative lg:mt-10 lg:max-w-6xl lg:mx-auto lg:pt-1.5">
        <h1 className="ml-6 md:ml-0 text-white font-cfont1 uppercase tracking-md leading-xs text-left md:pl-6 md:text-xl md:tracking-widest md:leading-6 lg:text-[28px] lg:tracking-xl lg:leading-md lg:pl-11 lg:mb-10">
          <strong className="opacity-25 pr-3">01 </strong>Pick your destination
        </h1>
        <div className="font-cfont1 text-white bg-cover bg-center">
          <div className="flex flex-col lg:flex-row justify-center max-w-6xl relative lg:py-5 lg:p-10 md:gap-32">
            ...
            <div className="right m-auto w-3/4 lg:w-1/2 text-white text-center lg:text-left g:mb-0 md:-mt-28 lg:-mt-10">
              ...
              <h1 className="planetName font-normal text-[80px] lg:text-[100px] font-cfont2 leading-[100px] lg:leading-[200px] uppercase">
                {item?.name}
              </h1>
              ...
              <div className="border-t border-gray mt-8 pt-8 flex flex-col gap-8 pb-0.5 md:mt-12 md:pt-7 md:flex-row md:gap-24 md:justify-center lg:justify-start lg:gap-20">
                <div className="grid gap-3">
                  <span className="text-sm -text--clr-pale-blue font-cfont1 uppercase tracking-widest leading-xxs">
                    Avg. distance
                  </span>
                  <span className="text-white font-cfont2 uppercase text-[28px] leading-8">
                    {item?.distance}
                  </span>
                </div>
                <div className="grid gap-3 lg:-ml-px">
                  <span className="text-sm -text--clr-pale-blue font-cfont1 uppercase tracking-widest">
                    Est. travel time
                  </span>
                  <span className="text-white font-cfont2 uppercase text-[28px] leading-8">
                    {item?.travel}
