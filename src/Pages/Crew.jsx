        ...
        <div className="font-cfont2 text-white bg-cover bg-center">
          <div className="flex flex-col-reverse lg:flex-row justify-center max-w-6xl relative lg:py-5 lg:p-10 md:gap-32">
            <div className="left m-auto w-3/4 lg:w-3/2 text-white text-center lg:text-left ">
              ...
              <h1 className="planetName font-normal text-[35px] lg:text-6xl font-cfont2 uppercase lg:my-6 whitespace-nowrap">
                {item?.name}
              </h1>
              <p className="font-cfont3 text-lg -text--clr-pale-blue ">
                {item?.bio}
              </p>
