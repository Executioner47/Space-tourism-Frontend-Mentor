  ...
  return (
    <div className="font-cfont2 bg-black text-white ">
      ...
      <div className="relative xl:mt-10 xl:max-w-6xl xl:mx-auto xl:pt-1.5 overflow-hidden">
        <h1 className="xl:mb-20 mb-10 ml-6 md:ml-0 text-white font-cfont1 uppercase tracking-md leading-xs text-left md:pl-6 md:text-xl md:tracking-widest md:leading-6 xl:text-[28px] xl:tracking-xl xl:leading-md ">
          <strong className="opacity-25 pr-3 ">03 </strong>SPACE LAUNCH 101
        </h1>
        <div className="font-cfont2 text-white bg-cover bg-center">
          <div className="flex flex-col-reverse xl:flex-row justify-center max-w-6xl relative xl:py-5 xl:gap-32">
            <div className="left flex flex-col xl:flex-row m-auto w-3/4 xl:w-3/2 text-white text-center xl:text-left xl:gap-x-14">
              ...
              <div className="text">
                <h3 className="uppercase text-[12px] font-cfont1 xl:text-[16px] text-[#FFFFFF]/50">
                  THE TERMINOLOGY…
                </h3>

                <h1 className="planetName font-normal text-[25px] xl:text-6xl font-cfont2 uppercase xl:my-6 whitespace-nowrap">
                  {item?.name}
                </h1>
                <p className="font-cfont3 text-[15px] lg:text-xl -text--clr-pale-blue leading-loose">
                  {item?.description}
                </p>
              </div>
            </div>
